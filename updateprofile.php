...
.custom-square-image:hover {
            border-color:black;
            border-radius: 50%; /* Slightly reduce border radius */
        ...
        .custom-square-image:hover img {
            border-color:black;
            transform: scale(0.5); /* Enlarge the image more on hover */
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-sm-4">
                        ...
                        <div class="image-upload-container">
                            <label for="image-upload" class="image-upload-label">
                                ...
                                <div class="custom-square-image">
                                    <img src="" alt="Upload Image" style="max-width: 100%; max-height: 100%;">
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <form action="deleteuser.php" method="POST" name="delete">
                    <div class="btn  bbb">
